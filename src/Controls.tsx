...
export function Controls() {
  ...
  return <div className="bg-slate-950 flex-[0_500px] flex flex-col justify-center">
    ...
    <button onClick={ settingsContext.toggleLightHelpers } className="p-1 mx-3 my-1 border-1 border-sky-400 rounded-md text-sky-400">
      { settingsContext.lightHelpers ? 'Disable Light Helpers' : 'Enable Light Helpers' }
    </button>
    <button onClick={ settingsContext.toggleTestCube } className="p1 mx-3 my-1 border-1 border-sky-400 rounded-md text-sky-400">
